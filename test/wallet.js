...
// Truffle automatically injects an 'artifacts' sol object
// Truffle automatically injects an 'web3' javascript library object
contract('Wallet', (accounts) => {
  ...
  it('should have correct approvers and quorum', async () => {
    ...
    assert(quorum.toNumber() === 2); // bn.js library (Big Number) is built in
  })

  it('should create tranfers if sender is approved', async () => {
